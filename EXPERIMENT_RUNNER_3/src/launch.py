...
####################################################################
EXP_DIR = "/nfs/storage1/home/biyikh/irony_detection/experiment_two_nov5" # filepath to directory containing train/val/test splits; outputs (e.g. metrics and saved models) will go here
